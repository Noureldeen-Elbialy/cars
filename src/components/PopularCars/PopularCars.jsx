    ...
    return (
        <section id="popularCars" className="py-5">
            ...
            <div className="flex justify-center mt-10">
                <Link to={'/cars'} className="border text-gray-500 py-2 text-xl px-12 border-gray-500 flex items-center rounded-lg justify-center hover:bg-gray-500 hover:text-white"><span>Show All Vehicles</span><span><ArrowRight /></span></Link>
            </div>
        </section>
    )
}
